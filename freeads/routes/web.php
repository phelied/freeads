...
|
*/
Route::get("/", [AnnonceController::class, "showIndex"]);
Route::get("/register", [RegisterController::class, "create"]);
Route::post("register", [RegisterController::class, "store"]);
Route::get("/search/{annonce}", [AnnonceController::class, "showResearch"]);
Route::get("/show/{annonce}", [AnnonceController::class, "show"]);
Route::get('ajax-autocomplete-search', [AnnonceController::class, 'research']);
